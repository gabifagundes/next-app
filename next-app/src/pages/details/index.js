...
class Detail extends Component {
  ...
  render() {
      ...
      const selectedGenres = genre_ids ?genre_ids.map(item => {
                const selected = _.find(genre, { id: item });
                return selected ? <span className="white mr4">{selected.name}, </span> : null;
             }):null;

             console.log(genre);
             const actors = people
               ? this.collapsibleItem(people.cast)
               : null;

             const team = people
               ? this.collapsibleItem(people.crew)
               : null;
                 ...
                 {this.props.data ? (
                   <div className="Grid">
                     <div className="u-sizeFull u-sm-size6of12 u-md-size6of12 u-lg-size6of12 order-2 order-1-ns">
                       ...
                       <div className="mb32 flex flex-column flex-row-ns">
                        ...
                        <FavoriteButton data={this.props.data} />
                         ...
                         <div className="f18">
                           <span className={`fw7 ${styles.title}`}>
                             Plot
                           </span>
                       ...
                       {selectedGenres && (
                         <div className="f18 dib mb12 ">
                           <span
                             className={`fw7 mr4 ${styles.title}`}
                           >
                             Genres:
                           </span>
                           {selectedGenres}
                     ...
                     <div className="u-sizeFull u-sm-size6of12  u-md-size6of12  u-lg-size6of12 order-1 order-2-ns flex justify-center pl32-ns">
                       <img
                         src={poster}
                         className={`mt32 mt0-ns ml0 ml-32-ns ${
                           styles.img
                         }`}
                         alt={title}
                       />
